...
class CarrierSelectionLog(Base):
    ...
    HANRA42001 = Column("HANRA42001", DECIMAL(10, 0), nullable=False)  # ログ識別連番
    ...
    HANRA42999 = Column("HANRA42999", DECIMAL(9, 0), primary_key=True, autoincrement=True, nullable=False, default=0) #更新番号
