...
class Waybill(Base):
    ...
    HANRA41002 = Column("HANRA41002", DECIMAL(8, 0), nullable=False)  # 出荷予定日
    HANRA41003 = Column("HANRA41003", DECIMAL(8, 0), nullable=False)  # 納期日
    HANRA41004 = Column("HANRA41004", CHAR(11), nullable=False)  # 取引先コード
    HANRA41005 = Column("HANRA41005", DECIMAL(1, 0), nullable=False)  # 納期情報1
    HANRA41006 = Column("HANRA41006", DECIMAL(1, 0), nullable=False) # 納期情報2
    HANRA41007 = Column("HANRA41007", NVARCHAR(32), nullable=True) # 納品先名1
    HANRA41008 = Column("HANRA41008", NVARCHAR(32), nullable=True) # 納品先名2
    HANRA41009 = Column("HANRA41009", CHAR(10), nullable=False)  # 納品先郵便番号
