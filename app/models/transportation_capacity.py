...
class TransportationCapacity(Base):
    ...
    HANMA47002 = Column("HANMA47002", DECIMAL(10, 0), nullable=True) #todo not null

    # 3. 最大重量（kg） - Max Weight (DECIMAL(10,0))
    HANMA47003 = Column("HANMA47003", DECIMAL(10, 0), nullable=True) #todo not null

    # 4. 才数換算重量（kg） - Weight per Volume (DECIMAL(3,0))
    HANMA47004 = Column("HANMA47004", DECIMAL(3, 0), nullable=True) #todo not null
