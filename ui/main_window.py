...
class MainWindow(QMainWindow):
    ...
    def update_table(self, items):
        ...
        for row, item in enumerate(items):
            ...
            self.table.setItem(row, 2, QTableWidgetItem(str(item.get("picking_id", ""))))
            self.table.setItem(row, 3, QTableWidgetItem(str(item.get("picking_date", ""))))
            self.table.setItem(row, 4, QTableWidgetItem(str(item.get("picking_time", ""))))
            self.table.setItem(row, 5, QTableWidgetItem(str(item.get("shipping_date", ""))))
            self.table.setItem(row, 6, QTableWidgetItem(str(item.get("order_no_from", ""))))
            self.table.setItem(row, 7, QTableWidgetItem(str(item.get("order_no_to", ""))))
            self.table.setItem(row, 8, QTableWidgetItem(str(item.get("customer_code_from", ""))))
            self.table.setItem(row, 9, QTableWidgetItem(str(item.get("customer_code_to", "111"))))
            self.table.setItem(row, 10, QTableWidgetItem(str(item.get("customer_short_name", ""))))
            self.table.setItem(row, 11, QTableWidgetItem(str(item.get("staff_code", ""))))
            self.table.setItem(row, 12, QTableWidgetItem(str(item.get("staff_short_name", ""))))
